...
{
    // Модификаторы доступа этих полей должны быть protected или вообще private, так как за границей класса
...
// В PHP 7.0 можно указывать типы возвращаемых функциями значений, в PHP 7.1 есть nullable.
// Нужно это использовать по максимуму. От строгой типизации хуже не будет, а что меньше возможностей для
// совершения ошибок в будущем - факт.